...
local function on_attach(client, bufnr)
  ...
  do
    ...
    vim.keymap.set("n", "<leader>lwl", _1_, {buffer = true, desc = "LSP -- list workspace folders", noremap = true, silent = true})
...
return {"williamboman/mason.nvim", dependencies = {"williamboman/mason-lspconfig.nvim", "neovim/nvim-lspconfig"}, ft = {"fennel", "c", "cpp", "lua", "typescript", "javascript"}, config = _2_}
